...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/main-sidebar_trans.invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/main-sidebar_trans.invoices_list')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                      @if($invoice->invoice_status == 1)
                                                           <span class="badge badge-danger"> {{trans('Doctors.nu_invoice')}}</span>
                                                      @elseif($invoice->invoice_status == 2)
                                                           <span class="badge badge-warning">{{trans('Doctors.r_invoice')}}</span>
                                                       @else
                                                          <span class="badge badge-success">{{trans('Doctors.c_invoice')}}</span>
                                                       @endif
                                                   </td>
