...
@endsection
@section('title')
{{trans('Ambulances.edit_Ambulance')}}
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('Ambulances.Ambulance')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{trans('Ambulances.edit_Ambulance')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('Ambulance.update','test')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{trans('Ambulances.car_num')}}</label>
                        ...
                        <div class="col">
                            <label>{{trans('Ambulances.car_type')}}</label>
                            <select class="form-control" name="car_type">
                                <option value="1" {{$ambulance->car_type == 1 ? 'selected':''}}>{{trans('Ambulances.Owned')}}</option>
                                <option value="2" {{$ambulance->car_type == 2 ? 'selected':''}}>{{trans('Ambulances.rent')}}</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label>{{trans('Ambulances.phone_num')}}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{trans('Ambulances.notes')}}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label>{{trans('Ambulances.status')}}</label>
                            &nbsp;
                    ...
                    <div class="row">
                        <div class="col">
                            <button class="btn btn-success">{{trans('Ambulances.save_data')}}</button>
                        </div>
                    </div>
