...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('patient.patient')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{trans('patient.patient_list')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th>{{trans('patient.date')}}</th>
												<th>{{trans('patient.phone')}}</th>
												<th>{{trans('patient.gender')}}</th>
                                                <th >{{trans('patient.blood_type')}}</th>
                                                <th >{{trans('patient.address')}}</th>
                                                <th>{{trans('patient.process')}}</th>
											</tr>
										</thead>
										<tbody>
