...
@endsection
@section('title')
    {{trans('patient.edit_patient_data')}}
    @endsection
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('patient.patient')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{trans('patient.edit_patient_data')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
