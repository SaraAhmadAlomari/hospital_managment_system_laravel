...
<button class="btn btn-primary pull-right"type="button" wire:click="show_form_add">{{trans('Groups.add_Services_group')}}</button><br><br>
<div class="table-responsive">
        ...
        <thead>
            <tr>
                ...
                <th>{{trans('Groups.Total_with_tax')}}</th>
                <th>{{trans('Groups.note')}}</th>
                <th>{{trans('Groups.process')}}</th>
            </tr>
        </thead>
        <tbody>
