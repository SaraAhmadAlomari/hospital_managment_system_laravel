<div>
    ...
    @if ($InvoiceSaved)
        <div class="alert alert-info">Data has been saved successfully</div>
    @endif

    @if ($InvoiceUpdated)
        <div class="alert alert-info">Data has been Edited successfully</div>
    @endif
    ...
    <form wire:submit.prevent="store" autocomplete="off">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        {{-- wire:model="patient_id" = value="$Patient->id --}}
