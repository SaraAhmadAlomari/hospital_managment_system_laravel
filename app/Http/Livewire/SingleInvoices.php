...
class SingleInvoices extends Component
{
    ...
    public $price, $discount_value = 0, $patient_id,
        $doctor_id, $section_id,
        $type, $Service_id,
        $single_invoice_id, $catchError;
    ...
    {
        return view('livewire.singleInvoices.single_invoices', [
    ...
    {
        $doctor_id = Doctor::with('section')->where('id', $this->doctor_id)->first(); //joy
