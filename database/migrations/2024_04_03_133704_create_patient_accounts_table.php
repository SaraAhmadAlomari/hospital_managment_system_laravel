...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('patient_accounts', function (Blueprint $table) {
            ...
            // $table->foreignId('group_id')->nullable()->references('id')->on('group_invoices')->onDelete('cascade');
            $table->foreignId('invoice_id')->nullable()->references('id')->on('invoices')->onDelete('cascade');
            $table->foreignId('receipt_id')->nullable()->references('id')->on('recipt_accounts')->onDelete('cascade');
